...
import { FaExternalLinkAlt } from "react-icons/fa"; // Ikonnya disamain sama navbar
        ...
        <section id="home" className="min-h-screen flex flex-col justify-center items-center text-center relative overflow-hidden px-4 pt-16">
            ...
            <div className="relative z-10 max-w-4xl space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed mt-4">
                    Informatics Engineering student at <span className="text-gray-200 font-medium">Politeknik Negeri Bandung</span>.<br /> 
                    I enjoy bridging the gap between intuitive front-end interfaces and reliable back-end logic to build end-to-end applications.
                </p>
